...
class NewsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $pengumumanCategory = \App\Models\NewsCategory::where('slug', 'pengumuman')->first();
        $prestasiCategory = \App\Models\NewsCategory::where('slug', 'prestasi')->first();
        $kemitraanCategory = \App\Models\NewsCategory::where('slug', 'kemitraan')->first();
        $pembelajaranCategory = \App\Models\NewsCategory::where('slug', 'pembelajaran')->first();
        $kegiatanCategory = \App\Models\NewsCategory::where('slug', 'kegiatan-sekolah')->first();
        ...
        $newsData = [
            [
                ...
                'news_category_id' => $pengumumanCategory?->id,
                'status' => 'published',
                ...
                'gambar' => 'https://picsum.photos/id/180/1200/800',
                'featured' => true,
                'views' => 150
            ],
            [
                ...
                'news_category_id' => $prestasiCategory?->id,
                'status' => 'published',
                ...
                'gambar' => 'https://picsum.photos/id/0/1200/800',
                'featured' => true,
                'views' => 89
            ],
            [
                ...
                'news_category_id' => $kemitraanCategory?->id,
                'status' => 'published',
                ...
                'gambar' => 'https://picsum.photos/id/201/1200/800',
                'featured' => false,
                'views' => 67
            ],
            [
                ...
                'news_category_id' => $pembelajaranCategory?->id,
                'status' => 'published',
                ...
                'gambar' => 'https://picsum.photos/id/119/1200/800',
                'featured' => false,
                'views' => 45
            ],
            [
                ...
                'news_category_id' => $kegiatanCategory?->id,
                'status' => 'published',
                ...
                'gambar' => 'https://picsum.photos/id/326/1200/800',
                'featured' => false,
                'views' => 78
            ]
        ];

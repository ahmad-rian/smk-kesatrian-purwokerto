{{-- Edit User Form (rendered inside parent modal) --}}
<div>
    @if ($user)
        {{-- User Info Header --}}
        ...
        <form wire:submit="update" class="space-y-6">
            ...
            <div class="flex justify-end gap-3 pt-4 border-t border-slate-200">
                <x-mary-button label="Batal" wire:click="$parent.closeEditModal" class="btn-ghost" />
                <x-mary-button label="Perbarui User" type="submit" spinner="update" class="btn-primary"

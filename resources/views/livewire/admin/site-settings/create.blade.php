<div>
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="title text-2xl font-bold text-base-content">Buat Pengaturan Situs</h1>
            <p class="body text-base-content/70 mt-1">Atur informasi dasar sekolah dan pengaturan situs</p>
        </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <x-mary-file 
                            ...
                            wire:model="logo" 
                            accept="image/*"
                            hint="Format: JPG, PNG, WebP. Maksimal 2MB" />

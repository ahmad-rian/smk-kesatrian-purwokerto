    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">
                Edit Kategori: {{ $newsCategory->name }}
            </h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="text-center">
                <div class="text-2xl font-bold text-green-600 dark:text-green-400">
                    {{ $newsCategory->published_news_count }}
                </div>
                <div class="text-sm text-gray-500 dark:text-gray-400">
                    Berita Dipublikasi
                </div>
            ...
            <div class="text-center">
                <div
                    class="text-2xl font-bold {{ $newsCategory->is_active ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}">
                    {{ $newsCategory->is_active ? 'Aktif' : 'Nonaktif' }}
                </div>
                <div class="text-sm text-gray-500 dark:text-gray-400">
                    Status Kategori
                </div>

                    ...
                    <div class="bg-base-200 rounded-lg p-4">
                        ...
                        @if($gambarPreview)
                            ...
                            <div class="mb-4">
                                ...
                                @if($gambar)
                                    <!-- Gambar baru dipilih -->
                                    <div class="mt-2 p-2 bg-info/10 rounded border border-info/20">
                                        <p class="text-sm text-info font-medium">Gambar baru dipilih</p>
                                        <p class="text-xs text-info/70">Gambar lama akan diganti saat menyimpan</p>
                                    </div>
                                @endif
                                ...
                                <div class="flex gap-2 mt-3">
                                    <input type="file" wire:model="gambar" 
                                           ...
                                           class="hidden" 
                                           id="gambar-upload">
                                    <label for="gambar-upload" class="btn btn-sm btn-outline flex-1">

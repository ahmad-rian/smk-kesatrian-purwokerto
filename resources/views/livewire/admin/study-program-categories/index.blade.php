    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-400 mt-1">
                Kelola kategori untuk mengorganisir program studi
            </p>
        </div>

        <div class="flex gap-2">
            <x-mary-button wire:navigate href="{{ route('admin.study-program-categories.create') }}" icon="o-plus"
                class="btn-primary">
                Tambah Kategori
            </x-mary-button>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
                <select wire:model.live="statusFilter"
                    class="select select-bordered w-full bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    ...
                                    {{ $category->study_programs_count ?? 0 }} program
                                </span>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end gap-2">
                                    <x-mary-button wire:navigate
                                        href="{{ route('admin.study-program-categories.edit', $category) }}" icon="o-pencil"
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                <div class="text-gray-500 dark:text-gray-400">
                                    <x-mary-icon name="o-academic-cap" class="w-12 h-12 mx-auto mb-4 text-gray-300" />
                                    <p class="text-lg font-medium">Belum ada kategori program studi</p>
                                    <p class="mt-1">Tambah kategori pertama untuk mengorganisir program studi</p>
                                    <div class="mt-4">
                                        <x-mary-button wire:navigate href="{{ route('admin.study-program-categories.create') }}"
    ...
    <x-mary-modal wire:model="showDeleteModal" title="Konfirmasi Hapus">
        @if ($categoryToDelete)
            <div class="space-y-4">
                ...
                @if (($categoryToDelete->study_programs_count ?? 0) > 0)
                    <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                        <div class="flex items-center">
                            ...
                            <span class="text-red-800 dark:text-red-200 font-medium">
                                Kategori ini memiliki {{ $categoryToDelete->study_programs_count }} program studi dan tidak dapat
                                dihapus.
                            </span>
                        </div>
                    </div>
        ...
        <x-slot:actions>
            ...
            @if ($categoryToDelete && ($categoryToDelete->study_programs_count ?? 0) === 0)

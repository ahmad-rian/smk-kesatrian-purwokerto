<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-400 mt-1">
                Edit menu: <strong>{{ $frontendMenu->title }}</strong>
            </p>
        </div>
    ...
    <form wire:submit="save" class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 space-y-6">
            ...
            {{-- Title --}}
            <div>
                <x-mary-input wire:model="title" label="Nama Menu *"
                ...
                <div>
                    ...
                    <div class="mt-3 flex items-center gap-4">
                        @if($page_featured_image)
                            <div>
                                <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Preview Baru:</p>
                        ...
                        @if($current_featured_image)
                            <div>
                                ...
                                <img src="{{ Storage::url($current_featured_image) }}"
                                    alt="Current"
                                    class="w-48 h-32 object-cover rounded-lg shadow">
                            </div>
                        @endif
        ...
        <div class="flex justify-end gap-3">
            ...
            <x-mary-button type="submit" class="btn-primary" spinner="save">
                {{ $type === 'page' ? 'Simpan Menu & Halaman' : 'Simpan Perubahan' }}
            </x-mary-button>
        </div>
    </form>
</div>

                                ...
                                @if ($activity->tanggal_kegiatan)
                                    <div class="flex items-center gap-3 text-slate-700">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-sm" style="font-family: 'Inter', sans-serif;">
                                                {{ \Carbon\Carbon::parse($activity->tanggal_kegiatan)->format('d F Y') }}
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="space-y-6">
                                @if ($activity->tanggal_kegiatan)
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-sm font-medium text-slate-500 mb-1">Tanggal Kegiatan</p>
                                ...
                                @if ($activity->lokasi)
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-sm font-medium text-slate-500 mb-1">Lokasi</p>
                                            <p class="text-lg font-semibold text-slate-900"
                                                style="font-family: 'Inter', sans-serif;">
                                                {{ $activity->lokasi }}
                                            </p>
    ...
    @else
        ...
        <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-blue-50">
            <div class="text-center max-w-md mx-auto px-6">
                <div class="mb-8">
                    <div class="w-32 h-32 mx-auto bg-white rounded-3xl shadow-lg flex items-center justify-center">
                ...
                <p class="text-lg text-slate-600 mb-8 leading-relaxed" style="font-family: 'Inter', sans-serif;">
